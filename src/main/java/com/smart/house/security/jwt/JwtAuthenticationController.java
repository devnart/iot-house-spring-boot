...
import com.smart.house.entity.JwtRequest;
import com.smart.house.entity.JwtResponse;
...
public class JwtAuthenticationController {
    ...
    public ResponseEntity<?> generateAuthenticationToken(@RequestBody JwtRequest authenticationRequest)
        ...
        Boolean isAuth = authenticate(authenticationRequest.getUsername(), authenticationRequest.getPassword());
